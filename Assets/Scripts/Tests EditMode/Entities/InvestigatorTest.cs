...
//            investigator.Create(5, 5, 5, true, true, fakes.CardOne, new DeckBuildingRules01001());
//        }
...
//            investigator.Create(physicalTrauma, mentalTrauma, 5, true, isRetired, fakes.CardOne, new DeckBuildingRules01001());
