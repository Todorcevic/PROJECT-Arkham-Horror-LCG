...
//                inv.Create(5, 5, 5, true, true, CardOne, new DeckBuildingRules01001());
...
//            InvestigatorOne = new Investigator();
//            InvestigatorTwo = new Investigator();
//            InvestigatorOne.Create(5, 5, 5, true, true, CardOne, new DeckBuildingRules01001());
//            InvestigatorTwo.Create(8, 8, 8, false, false, CardTwo, new DeckBuildingRules01001());
//        }
//    }
//}
